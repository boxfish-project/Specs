...
Pod::Spec.new do |s|
  ...
  s.name         = "BFEUMengSocial"
  s.version      = "4.2.3"
  s.summary      = "Fork UMeng's official Social SDK for iOS."
  ...
  s.author             = { "lvhuan" => "lhach92@163.com" }
  ...
  s.source       = { :http => "http://boxfish.oss-cn-hangzhou.aliyuncs.com/umeng_ios_social_sdk_4.2.3_arm64_custom.zip" }
